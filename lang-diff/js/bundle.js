...
},{"./langDiff.coffee":116,"highlight.js":2}],116:[function(require,module,exports){
var langDiff;

langDiff = {
  translate: function(pos, lang, codeLines) {
    var body, contentBody, elementId, i, line, lineNumbers, numBody, _i, _len;
    ...
    body = this.tag('pre', this.tag('code', contentBody, {
      "class": langDiff.resolveName(lang),
      id: elementId
    }));
    numBody = this.tag('pre', this.tag('code', lineNumbers, {
      "class": langDiff.resolveName(lang),
      id: elementId + '-number'
    }));
    return {
